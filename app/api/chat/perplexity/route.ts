...
export async function POST(request: Request) {
  ...
  try {
    ...
    const KEY = profile.perplexity_api_key

    checkApiKey(KEY, "Perplexity")
    ...
    logger.error("chat route failed", { provider: "perplexity", model: chatSettings?.model, error: error.message })
