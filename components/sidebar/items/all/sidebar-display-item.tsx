  ...
  return (
    ...
    >
      <div
        ref={itemRef}
        className={cn(
          "group flex w-full cursor-pointer items-center h-[37px] rounded-lg px-2 py-1 focus:outline-none font-instrument transition-colors text-foreground-secondary hover:bg-accent/50"
        )}
        tabIndex={0}
